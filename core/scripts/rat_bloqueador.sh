...
xinput set-prop "$f1" "Device Enabled" 0 2> /dev/null
xinput set-prop "$f2" "Device Enabled" 0 2> /dev/null
xinput set-prop "$f3" "Device Enabled" 0 2> /dev/null
xinput set-prop "$f4" "Device Enabled" 0 2> /dev/null
xinput set-prop "$f5" "Device Enabled" 0 2> /dev/null
